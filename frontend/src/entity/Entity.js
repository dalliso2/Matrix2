...
import { consolidatePropValues, getTitle } from "../util/utils";
...
import { Table, TableBody, Tooltip, Typography } from "@mui/material";
        ...
        <Box>
            <Box sx={{display:'flex',flexDirection:'column', width:'100%', p:2}}>
                <Box sx={{display:'flex', justifyContent:'space-between', width:'100%', pb:2}}>
                    <Box>
                        <IconButton style={{visibility:'hidden'}}><RefreshIcon/></IconButton>
                        <IconButton style={{visibility:'hidden'}}><RefreshIcon/></IconButton>
                    </Box>
                    <Box><Typography variant="h4">{getTitle(entityDefinitions, entity)}</Typography></Box> 
                    <Box>
                ...
                <Box sx={{ position:'relative', display:'flex', width:'100%', gap:'30px', justifyContent:'space-around', overflow:'hidden'}}>
                {
                    ...
                    <Box sx={{display:'flex', flexDirection:'column', alignItems:'center', maxWidth:'50%',p:1}}>
                    {
